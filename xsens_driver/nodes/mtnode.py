...
from std_msgs.msg import Header, String, UInt16, Float64
...
class XSensDriver(object):
    ...
    def spin_once(self):
        ...
        def fill_from_Orient(orient_data):
            ...
            #fill in the pitch info
            self.pub_pitch = True
            self.pitch_msg.data = orient_data['pitch']
